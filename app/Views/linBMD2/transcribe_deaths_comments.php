	...
	<br><br><br><br>
		<form action="<?php echo(base_url('deaths/comment_step2')) ?>" method="post">
			...
			<div class="row mt-4 d-flex justify-content-between">
					...
					<a id="return" class="btn btn-primary mr-0 flex-column align-items-center" href="<?php echo(base_url('deaths/transcribe_deaths_step1/0')); ?>">
						<span>Return</span>
					</a>
