	...
	<form action="<?php echo(base_url('births/transcribe_births_step2')) ?>" method="post">
		...
		<div class="form-inline row">
			...
			<input type="text" class="form-control col-2 pl-0" id="line" name="line" value="<?php echo esc($session->line);?>">	
			<span class="col-2 pl-0"></span>
			<span class="col-2 pl-0"></span>	
			<label class="sr-only" for="reverselookup">Lookup by volume</label>
			<input type="text" class="form-control col-2 pl-0" id="reverselookup" name="reverselookup" value="<?php echo esc($session->reverselookup);?>">
		</div>
		<div class="form-inline row">
			...
			<input type="text" class="form-control col-1 pl-0" id="registration" name="registration" autocomplete="off" value="<?php echo esc($session->registration);?>">
		...
		<div class="row mt-2">
			...
			<h6 title="mm.yy or just the month: eg 01, 09, 10. The system will add the year."class="col-1 pl-0 small text-muted">Registration* **</h6>
