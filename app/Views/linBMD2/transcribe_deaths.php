	...
	<form action="<?php echo(base_url('deaths/transcribe_deaths_step2')) ?>" method="post">
		...
		<div class="row mt-2 d-flex justify-content-between">
			<a id="duplicate_last_line" class="btn btn-warning mr-0 flex-column align-items-center" href="<?php echo(base_url('deaths/duplicate_firstname/0')); ?>">
				<span>Duplicate first name</span>
			</a>
			<a id="duplicate_last_line" class="btn btn-warning mr-0 flex-column align-items-center" href="<?php echo(base_url('deaths/duplicate_last_line/0')); ?>">
